...
INNER JOIN [LevelOne] AS [e1] ON [e4].[Name] = (
    ...
    WHERE [subQuery0].[Level1_Required_Id] = [e1].[Id]
        ...
        public override async Task Join_navigation_translated_to_subquery_deeply_nested_required(bool isAsync)
        {
            ...
            AssertSql(
                @"SELECT [e1].[Name] AS [Name1], [e1].[Id] AS [Id1]
FROM [LevelOne] AS [e1]",
                //
                @"SELECT [t].[Id], [t].[Level3_Optional_Id], [t].[Level3_Required_Id], [t].[Name], [t].[OneToMany_Optional_Inverse4Id], [t].[OneToMany_Optional_Self_Inverse4Id], [t].[OneToMany_Required_Inverse4Id], [t].[OneToMany_Required_Self_Inverse4Id], [t].[OneToOne_Optional_PK_Inverse4Id], [t].[OneToOne_Optional_Self4Id], [t].[Id0], [t].[Level2_Optional_Id], [t].[Level2_Required_Id], [t].[Name0], [t].[OneToMany_Optional_Inverse3Id], [t].[OneToMany_Optional_Self_Inverse3Id], [t].[OneToMany_Required_Inverse3Id], [t].[OneToMany_Required_Self_Inverse3Id], [t].[OneToOne_Optional_PK_Inverse3Id], [t].[OneToOne_Optional_Self3Id], [t].[Id1], [t].[Date], [t].[Level1_Optional_Id], [t].[Level1_Required_Id], [t].[Name1], [t].[OneToMany_Optional_Inverse2Id], [t].[OneToMany_Optional_Self_Inverse2Id], [t].[OneToMany_Required_Inverse2Id], [t].[OneToMany_Required_Self_Inverse2Id], [t].[OneToOne_Optional_PK_Inverse2Id], [t].[OneToOne_Optional_Self2Id], [t].[Id2], [t].[Date0], [t].[Name2], [t].[OneToMany_Optional_Self_Inverse1Id], [t].[OneToMany_Required_Self_Inverse1Id], [t].[OneToOne_Optional_Self1Id]
FROM (
    SELECT [e4].[Id], [e4].[Level3_Optional_Id], [e4].[Level3_Required_Id], [e4].[Name], [e4].[OneToMany_Optional_Inverse4Id], [e4].[OneToMany_Optional_Self_Inverse4Id], [e4].[OneToMany_Required_Inverse4Id], [e4].[OneToMany_Required_Self_Inverse4Id], [e4].[OneToOne_Optional_PK_Inverse4Id], [e4].[OneToOne_Optional_Self4Id], [e4.OneToOne_Required_FK_Inverse4].[Id] AS [Id0], [e4.OneToOne_Required_FK_Inverse4].[Level2_Optional_Id], [e4.OneToOne_Required_FK_Inverse4].[Level2_Required_Id], [e4.OneToOne_Required_FK_Inverse4].[Name] AS [Name0], [e4.OneToOne_Required_FK_Inverse4].[OneToMany_Optional_Inverse3Id], [e4.OneToOne_Required_FK_Inverse4].[OneToMany_Optional_Self_Inverse3Id], [e4.OneToOne_Required_FK_Inverse4].[OneToMany_Required_Inverse3Id], [e4.OneToOne_Required_FK_Inverse4].[OneToMany_Required_Self_Inverse3Id], [e4.OneToOne_Required_FK_Inverse4].[OneToOne_Optional_PK_Inverse3Id], [e4.OneToOne_Required_FK_Inverse4].[OneToOne_Optional_Self3Id], [e4.OneToOne_Required_FK_Inverse4.OneToOne_Required_FK_Inverse3].[Id] AS [Id1], [e4.OneToOne_Required_FK_Inverse4.OneToOne_Required_FK_Inverse3].[Date], [e4.OneToOne_Required_FK_Inverse4.OneToOne_Required_FK_Inverse3].[Level1_Optional_Id], [e4.OneToOne_Required_FK_Inverse4.OneToOne_Required_FK_Inverse3].[Level1_Required_Id], [e4.OneToOne_Required_FK_Inverse4.OneToOne_Required_FK_Inverse3].[Name] AS [Name1], [e4.OneToOne_Required_FK_Inverse4.OneToOne_Required_FK_Inverse3].[OneToMany_Optional_Inverse2Id], [e4.OneToOne_Required_FK_Inverse4.OneToOne_Required_FK_Inverse3].[OneToMany_Optional_Self_Inverse2Id], [e4.OneToOne_Required_FK_Inverse4.OneToOne_Required_FK_Inverse3].[OneToMany_Required_Inverse2Id], [e4.OneToOne_Required_FK_Inverse4.OneToOne_Required_FK_Inverse3].[OneToMany_Required_Self_Inverse2Id], [e4.OneToOne_Required_FK_Inverse4.OneToOne_Required_FK_Inverse3].[OneToOne_Optional_PK_Inverse2Id], [e4.OneToOne_Required_FK_Inverse4.OneToOne_Required_FK_Inverse3].[OneToOne_Optional_Self2Id], [e4.OneToOne_Required_FK_Inverse4.OneToOne_Required_FK_Inverse3.OneToOne_Required_PK_Inverse2].[Id] AS [Id2], [e4.OneToOne_Required_FK_Inverse4.OneToOne_Required_FK_Inverse3.OneToOne_Required_PK_Inverse2].[Date] AS [Date0], [e4.OneToOne_Required_FK_Inverse4.OneToOne_Required_FK_Inverse3.OneToOne_Required_PK_Inverse2].[Name] AS [Name2], [e4.OneToOne_Required_FK_Inverse4.OneToOne_Required_FK_Inverse3.OneToOne_Required_PK_Inverse2].[OneToMany_Optional_Self_Inverse1Id], [e4.OneToOne_Required_FK_Inverse4.OneToOne_Required_FK_Inverse3.OneToOne_Required_PK_Inverse2].[OneToMany_Required_Self_Inverse1Id], [e4.OneToOne_Required_FK_Inverse4.OneToOne_Required_FK_Inverse3.OneToOne_Required_PK_Inverse2].[OneToOne_Optional_Self1Id]
    FROM [LevelFour] AS [e4]
    INNER JOIN [LevelThree] AS [e4.OneToOne_Required_FK_Inverse4] ON [e4].[Level3_Required_Id] = [e4.OneToOne_Required_FK_Inverse4].[Id]
    INNER JOIN [LevelTwo] AS [e4.OneToOne_Required_FK_Inverse4.OneToOne_Required_FK_Inverse3] ON [e4.OneToOne_Required_FK_Inverse4].[Level2_Required_Id] = [e4.OneToOne_Required_FK_Inverse4.OneToOne_Required_FK_Inverse3].[Id]
    INNER JOIN [LevelOne] AS [e4.OneToOne_Required_FK_Inverse4.OneToOne_Required_FK_Inverse3.OneToOne_Required_PK_Inverse2] ON [e4.OneToOne_Required_FK_Inverse4.OneToOne_Required_FK_Inverse3].[Id] = [e4.OneToOne_Required_FK_Inverse4.OneToOne_Required_FK_Inverse3.OneToOne_Required_PK_Inverse2].[Id]
) AS [t]");
        }
...
ORDER BY [t].[Id]");
        ...
        public override async Task Select_nav_prop_collection_one_to_many_required(bool isAsync)
        {
            await base.Select_nav_prop_collection_one_to_many_required(isAsync);
...
ORDER BY [e].[Id]",
                //
                @"SELECT [t].[Id], [e.OneToMany_Required1].[Id], [e.OneToMany_Required1].[OneToMany_Required_Inverse2Id]
FROM [LevelTwo] AS [e.OneToMany_Required1]
INNER JOIN (
    SELECT [e0].[Id]
    FROM [LevelOne] AS [e0]
) AS [t] ON [e.OneToMany_Required1].[OneToMany_Required_Inverse2Id] = [t].[Id]
ORDER BY [t].[Id]");
        }
...
INNER JOIN (
    SELECT [l].[Id], [l].[Date], [l].[Level1_Optional_Id], [l].[Level1_Required_Id], [l].[Name], [l].[OneToMany_Optional_Inverse2Id], [l].[OneToMany_Optional_Self_Inverse2Id], [l].[OneToMany_Required_Inverse2Id], [l].[OneToMany_Required_Self_Inverse2Id], [l].[OneToOne_Optional_PK_Inverse2Id], [l].[OneToOne_Optional_Self2Id]
    FROM [LevelTwo] AS [l]
) AS [t] ON [e].[Id] = [t].[OneToMany_Optional_Inverse2Id]
WHERE [e].[Id] = 1");
        }
...
WHERE [l2o].[Id] = 7",
                //
                @"SELECT TOP(1) [ti.OneToOne_Required_FK_Inverse2].[Id], [ti.OneToOne_Required_FK_Inverse2].[Date], [ti.OneToOne_Required_FK_Inverse2].[Name], [ti.OneToOne_Required_FK_Inverse2].[OneToMany_Optional_Self_Inverse1Id], [ti.OneToOne_Required_FK_Inverse2].[OneToMany_Required_Self_Inverse1Id], [ti.OneToOne_Required_FK_Inverse2].[OneToOne_Optional_Self1Id], 7 AS [Constant]
FROM [LevelTwo] AS [l2i]
INNER JOIN [LevelOne] AS [l1i] ON [l2i].[Level1_Required_Id] = [l1i].[Id]
INNER JOIN [LevelOne] AS [ti.OneToOne_Required_FK_Inverse2] ON [l2i].[Level1_Required_Id] = [ti.OneToOne_Required_FK_Inverse2].[Id]
ORDER BY [l2i].[Id]");
        }
...
ORDER BY [l1].[Id]",
                //
                @"SELECT [t].[Id], CASE
    WHEN [l.OneToOne_Required_FK2].[Id] IS NULL
    THEN CAST(1 AS BIT) ELSE CAST(0 AS BIT)
END, [l.OneToOne_Required_FK2].[Name] AS [Value], [l1.OneToMany_Optional1].[OneToMany_Optional_Inverse2Id]
FROM [LevelTwo] AS [l1.OneToMany_Optional1]
LEFT JOIN [LevelThree] AS [l.OneToOne_Required_FK2] ON [l1.OneToMany_Optional1].[Id] = [l.OneToOne_Required_FK2].[Level2_Required_Id]
INNER JOIN (
    SELECT [l10].[Id]
    FROM [LevelOne] AS [l10]
) AS [t] ON [l1.OneToMany_Optional1].[OneToMany_Optional_Inverse2Id] = [t].[Id]
...
LEFT JOIN [LevelTwo] AS [l1.OneToOne_Optional_FK1] ON [l1].[Id] = [l1.OneToOne_Optional_FK1].[Level1_Optional_Id]
LEFT JOIN [LevelThree] AS [l1.OneToOne_Optional_FK1.OneToOne_Optional_PK2] ON [l1.OneToOne_Optional_FK1].[Id] = [l1.OneToOne_Optional_FK1.OneToOne_Optional_PK2].[OneToOne_Optional_PK_Inverse3Id]
WHERE ([l1.OneToOne_Optional_FK1.OneToOne_Optional_PK2].[Name] <> N'Foo') OR [l1.OneToOne_Optional_FK1.OneToOne_Optional_PK2].[Name] IS NULL");
        }

        public override void Nav3()
        {
            base.Nav3();
...
WHERE ([l1.OneToOne_Optional_FK1.OneToOne_Optional_PK2].[Name] <> N'Foo') OR [l1.OneToOne_Optional_FK1.OneToOne_Optional_PK2].[Name] IS NULL");
        ...
        public override void Nav5()
        {
            base.Nav5();

            AssertSql(
                @"SELECT [x.OneToOne_Optional_PK2].[OneToOne_Optional_PK_Inverse3Id], [x.OneToOne_Optional_PK2].[Name]
FROM [LevelThree] AS [x.OneToOne_Optional_PK2]",
                //
                @"SELECT [t].[Id], [t].[Date], [t].[Level1_Optional_Id], [t].[Level1_Required_Id], [t].[Name], [t].[OneToMany_Optional_Inverse2Id], [t].[OneToMany_Optional_Self_Inverse2Id], [t].[OneToMany_Required_Inverse2Id], [t].[OneToMany_Required_Self_Inverse2Id], [t].[OneToOne_Optional_PK_Inverse2Id], [t].[OneToOne_Optional_Self2Id]
FROM (
    SELECT DISTINCT [l1.OneToOne_Optional_FK1].[Id], [l1.OneToOne_Optional_FK1].[Date], [l1.OneToOne_Optional_FK1].[Level1_Optional_Id], [l1.OneToOne_Optional_FK1].[Level1_Required_Id], [l1.OneToOne_Optional_FK1].[Name], [l1.OneToOne_Optional_FK1].[OneToMany_Optional_Inverse2Id], [l1.OneToOne_Optional_FK1].[OneToMany_Optional_Self_Inverse2Id], [l1.OneToOne_Optional_FK1].[OneToMany_Required_Inverse2Id], [l1.OneToOne_Optional_FK1].[OneToMany_Required_Self_Inverse2Id], [l1.OneToOne_Optional_FK1].[OneToOne_Optional_PK_Inverse2Id], [l1.OneToOne_Optional_FK1].[OneToOne_Optional_Self2Id]
    FROM [LevelOne] AS [l1]
    LEFT JOIN [LevelTwo] AS [l1.OneToOne_Optional_FK1] ON [l1].[Id] = [l1.OneToOne_Optional_FK1].[Level1_Optional_Id]
) AS [t]");
        }

        public override void Nav5_1()
        {
            base.Nav5_1();
...
FROM (
    SELECT DISTINCT [l1.OneToOne_Optional_FK1].[Id], [l1.OneToOne_Optional_FK1].[Date], [l1.OneToOne_Optional_FK1].[Level1_Optional_Id], [l1.OneToOne_Optional_FK1].[Level1_Required_Id], [l1.OneToOne_Optional_FK1].[Name], [l1.OneToOne_Optional_FK1].[OneToMany_Optional_Inverse2Id], [l1.OneToOne_Optional_FK1].[OneToMany_Optional_Self_Inverse2Id], [l1.OneToOne_Optional_FK1].[OneToMany_Required_Inverse2Id], [l1.OneToOne_Optional_FK1].[OneToMany_Required_Self_Inverse2Id], [l1.OneToOne_Optional_FK1].[OneToOne_Optional_PK_Inverse2Id], [l1.OneToOne_Optional_FK1].[OneToOne_Optional_Self2Id], [l1.OneToOne_Optional_FK1.OneToOne_Optional_PK1].[Id] AS [Id0], [l1.OneToOne_Optional_FK1.OneToOne_Optional_PK1].[Date] AS [Date0], [l1.OneToOne_Optional_FK1.OneToOne_Optional_PK1].[Level1_Optional_Id] AS [Level1_Optional_Id0], [l1.OneToOne_Optional_FK1.OneToOne_Optional_PK1].[Level1_Required_Id] AS [Level1_Required_Id0], [l1.OneToOne_Optional_FK1.OneToOne_Optional_PK1].[Name] AS [Name0], [l1.OneToOne_Optional_FK1.OneToOne_Optional_PK1].[OneToMany_Optional_Inverse2Id] AS [OneToMany_Optional_Inverse2Id0], [l1.OneToOne_Optional_FK1.OneToOne_Optional_PK1].[OneToMany_Optional_Self_Inverse2Id] AS [OneToMany_Optional_Self_Inverse2Id0], [l1.OneToOne_Optional_FK1.OneToOne_Optional_PK1].[OneToMany_Required_Inverse2Id] AS [OneToMany_Required_Inverse2Id0], [l1.OneToOne_Optional_FK1.OneToOne_Optional_PK1].[OneToMany_Required_Self_Inverse2Id] AS [OneToMany_Required_Self_Inverse2Id0], [l1.OneToOne_Optional_FK1.OneToOne_Optional_PK1].[OneToOne_Optional_PK_Inverse2Id] AS [OneToOne_Optional_PK_Inverse2Id0], [l1.OneToOne_Optional_FK1.OneToOne_Optional_PK1].[OneToOne_Optional_Self2Id] AS [OneToOne_Optional_Self2Id0]
    FROM [LevelOne] AS [l1]
    LEFT JOIN [LevelTwo] AS [l1.OneToOne_Optional_FK1] ON [l1].[Id] = [l1.OneToOne_Optional_FK1].[Level1_Optional_Id]
...
FROM [LevelThree] AS [x.OneToOne_Optional_PK2]",
                //
                @"SELECT [t].[Id], [t].[Date], [t].[Level1_Optional_Id], [t].[Level1_Required_Id], [t].[Name], [t].[OneToMany_Optional_Inverse2Id], [t].[OneToMany_Optional_Self_Inverse2Id], [t].[OneToMany_Required_Inverse2Id], [t].[OneToMany_Required_Self_Inverse2Id], [t].[OneToOne_Optional_PK_Inverse2Id], [t].[OneToOne_Optional_Self2Id], [t].[name0]
FROM (
    SELECT DISTINCT [l1.OneToOne_Optional_FK1].[Id], [l1.OneToOne_Optional_FK1].[Date], [l1.OneToOne_Optional_FK1].[Level1_Optional_Id], [l1.OneToOne_Optional_FK1].[Level1_Required_Id], [l1.OneToOne_Optional_FK1].[Name], [l1.OneToOne_Optional_FK1].[OneToMany_Optional_Inverse2Id], [l1.OneToOne_Optional_FK1].[OneToMany_Optional_Self_Inverse2Id], [l1.OneToOne_Optional_FK1].[OneToMany_Required_Inverse2Id], [l1.OneToOne_Optional_FK1].[OneToMany_Required_Self_Inverse2Id], [l1.OneToOne_Optional_FK1].[OneToOne_Optional_PK_Inverse2Id], [l1.OneToOne_Optional_FK1].[OneToOne_Optional_Self2Id], [l1.OneToOne_Optional_FK1.OneToOne_Optional_PK1].[Name] AS [name0]
    FROM [LevelOne] AS [l1]
    LEFT JOIN [LevelTwo] AS [l1.OneToOne_Optional_FK1] ON [l1].[Id] = [l1.OneToOne_Optional_FK1].[Level1_Optional_Id]
    LEFT JOIN [LevelTwo] AS [l1.OneToOne_Optional_FK1.OneToOne_Optional_PK1] ON [l1].[Id] = [l1.OneToOne_Optional_FK1.OneToOne_Optional_PK1].[OneToOne_Optional_PK_Inverse2Id]
) AS [t]
WHERE ([t].[name0] <> N'Bar') OR [t].[name0] IS NULL");
        }

        public override void Nav5_4()
        {
            base.Nav5_4();

            AssertSql(
                @"SELECT [x.OneToOne_Optional_PK2.OneToOne_Optional_PK2].[OneToOne_Optional_PK_Inverse3Id], [x.OneToOne_Optional_PK2.OneToOne_Optional_PK2].[Name]
FROM [LevelThree] AS [x.OneToOne_Optional_PK2.OneToOne_Optional_PK2]",
                //
                @"SELECT [x.OneToOne_Optional_PK2].[OneToOne_Optional_PK_Inverse3Id], [x.OneToOne_Optional_PK2].[Name]
FROM [LevelThree] AS [x.OneToOne_Optional_PK2]",
                //
...
FROM (
    ...
    LEFT JOIN [LevelTwo] AS [l1.OneToOne_Optional_FK1.OneToOne_Optional_PK1] ON [l1].[Id] = [l1.OneToOne_Optional_FK1.OneToOne_Optional_PK1].[OneToOne_Optional_PK_Inverse2Id]
        ...
        public override void Nav5_5()
        {
            base.Nav5_5();

            AssertSql(
                @"SELECT [xxx.OneToOne_Required_PK3].[Id], [xxx.OneToOne_Required_PK3].[Name]
FROM [LevelFour] AS [xxx.OneToOne_Required_PK3]",
                //
...
FROM (
    SELECT DISTINCT [l1.OneToOne_Optional_FK1.OneToOne_Optional_PK2].[Id], [l1.OneToOne_Optional_FK1.OneToOne_Optional_PK2].[Level2_Optional_Id], [l1.OneToOne_Optional_FK1.OneToOne_Optional_PK2].[Level2_Required_Id], [l1.OneToOne_Optional_FK1.OneToOne_Optional_PK2].[Name], [l1.OneToOne_Optional_FK1.OneToOne_Optional_PK2].[OneToMany_Optional_Inverse3Id], [l1.OneToOne_Optional_FK1.OneToOne_Optional_PK2].[OneToMany_Optional_Self_Inverse3Id], [l1.OneToOne_Optional_FK1.OneToOne_Optional_PK2].[OneToMany_Required_Inverse3Id], [l1.OneToOne_Optional_FK1.OneToOne_Optional_PK2].[OneToMany_Required_Self_Inverse3Id], [l1.OneToOne_Optional_FK1.OneToOne_Optional_PK2].[OneToOne_Optional_PK_Inverse3Id], [l1.OneToOne_Optional_FK1.OneToOne_Optional_PK2].[OneToOne_Optional_Self3Id]
    FROM [LevelOne] AS [l1]
    LEFT JOIN [LevelTwo] AS [l1.OneToOne_Optional_FK1] ON [l1].[Id] = [l1.OneToOne_Optional_FK1].[Level1_Optional_Id]
    LEFT JOIN [LevelThree] AS [l1.OneToOne_Optional_FK1.OneToOne_Optional_PK2] ON [l1.OneToOne_Optional_FK1].[Id] = [l1.OneToOne_Optional_FK1.OneToOne_Optional_PK2].[OneToOne_Optional_PK_Inverse3Id]
) AS [t]");
...
LEFT JOIN [LevelFour] AS [xxx.OneToOne_Required_PK3] ON [t].[Id] = [xxx.OneToOne_Required_PK3].[Id]
WHERE ([xxx.OneToOne_Required_PK3].[Name] <> N'Foo') OR [xxx.OneToOne_Required_PK3].[Name] IS NULL");
        }
...
LEFT JOIN [LevelTwo] AS [l.OneToOne_Optional_FK1] ON [l].[Id] = [l.OneToOne_Optional_FK1].[Level1_Optional_Id]");
        ...
        public override void SelectMany1()
        {
            ...
            AssertSql(
                @"SELECT [e].[Id], [e].[Date], [e].[Name], [e].[OneToMany_Optional_Self_Inverse1Id], [e].[OneToMany_Required_Self_Inverse1Id], [e].[OneToOne_Optional_Self1Id], [x].[Id], [x].[Date], [x].[Level1_Optional_Id], [x].[Level1_Required_Id], [x].[Name], [x].[OneToMany_Optional_Inverse2Id], [x].[OneToMany_Optional_Self_Inverse2Id], [x].[OneToMany_Required_Inverse2Id], [x].[OneToMany_Required_Self_Inverse2Id], [x].[OneToOne_Optional_PK_Inverse2Id], [x].[OneToOne_Optional_Self2Id]
FROM [LevelOne] AS [e]
LEFT JOIN [LevelTwo] AS [e.OneToOne_Optional_FK1] ON [e].[Id] = [e.OneToOne_Optional_FK1].[Level1_Optional_Id]
...
FROM [LevelOne] AS [e]
LEFT JOIN [LevelTwo] AS [e.OneToOne_Optional_FK1] ON [e].[Id] = [e.OneToOne_Optional_FK1].[Level1_Optional_Id]
LEFT JOIN [LevelTwo] AS [e.OneToOne_Optional_FK1.OneToOne_Optional_PK1] ON [e].[Id] = [e.OneToOne_Optional_FK1.OneToOne_Optional_PK1].[OneToOne_Optional_PK_Inverse2Id]
INNER JOIN (
    ...
    FROM [LevelThree] AS [l]
) AS [t] ON [e.OneToOne_Optional_FK1.OneToOne_Optional_PK1].[Id] = [t].[OneToMany_Optional_Inverse3Id]
WHERE ([e.OneToOne_Optional_FK1].[Name] <> N'Foo') OR [e.OneToOne_Optional_FK1].[Name] IS NULL");
        }
...
INNER JOIN [LevelTwo] AS [i] ON [l1.OneToOne_Optional_PK1].[Id] = [i].[Id]");
        ...
        public override void GroupJoin1()
        {
            base.GroupJoin1();
        ...
        public override void GroupJoin2()
        {
            base.GroupJoin2();
        ...
        public override void GroupJoin3()
        {
            base.GroupJoin3();

            AssertSql(
                @"SELECT [i].[Id], [i].[Date], [i].[Level1_Optional_Id], [i].[Level1_Required_Id], [i].[Name], [i].[OneToMany_Optional_Inverse2Id], [i].[OneToMany_Optional_Self_Inverse2Id], [i].[OneToMany_Required_Inverse2Id], [i].[OneToMany_Required_Self_Inverse2Id], [i].[OneToOne_Optional_PK_Inverse2Id], [i].[OneToOne_Optional_Self2Id], [ti.OneToOne_Optional_FK1].[Id], [ti.OneToOne_Optional_FK1].[Date], [ti.OneToOne_Optional_FK1].[Level1_Optional_Id], [ti.OneToOne_Optional_FK1].[Level1_Required_Id], [ti.OneToOne_Optional_FK1].[Name], [ti.OneToOne_Optional_FK1].[OneToMany_Optional_Inverse2Id], [ti.OneToOne_Optional_FK1].[OneToMany_Optional_Self_Inverse2Id], [ti.OneToOne_Optional_FK1].[OneToMany_Required_Inverse2Id], [ti.OneToOne_Optional_FK1].[OneToMany_Required_Self_Inverse2Id], [ti.OneToOne_Optional_FK1].[OneToOne_Optional_PK_Inverse2Id], [ti.OneToOne_Optional_FK1].[OneToOne_Optional_Self2Id]
FROM [LevelOne] AS [o]
LEFT JOIN [LevelTwo] AS [i] ON [o].[Id] = [i].[Level1_Optional_Id]
LEFT JOIN [LevelTwo] AS [ti.OneToOne_Optional_FK1] ON [o].[Id] = [ti.OneToOne_Optional_FK1].[Level1_Optional_Id]");
        }

        public override void GroupJoin4()
        {
            base.GroupJoin4();

            AssertSql(
                @"SELECT [l1.OneToOne_Optional_FK1].[Id], [l1.OneToOne_Optional_FK1].[Date], [l1.OneToOne_Optional_FK1].[Level1_Optional_Id], [l1.OneToOne_Optional_FK1].[Level1_Required_Id], [l1.OneToOne_Optional_FK1].[Name], [l1.OneToOne_Optional_FK1].[OneToMany_Optional_Inverse2Id], [l1.OneToOne_Optional_FK1].[OneToMany_Optional_Self_Inverse2Id], [l1.OneToOne_Optional_FK1].[OneToMany_Required_Inverse2Id], [l1.OneToOne_Optional_FK1].[OneToMany_Required_Self_Inverse2Id], [l1.OneToOne_Optional_FK1].[OneToOne_Optional_PK_Inverse2Id], [l1.OneToOne_Optional_FK1].[OneToOne_Optional_Self2Id], [i].[Id], [i].[Date], [i].[Level1_Optional_Id], [i].[Level1_Required_Id], [i].[Name], [i].[OneToMany_Optional_Inverse2Id], [i].[OneToMany_Optional_Self_Inverse2Id], [i].[OneToMany_Required_Inverse2Id], [i].[OneToMany_Required_Self_Inverse2Id], [i].[OneToOne_Optional_PK_Inverse2Id], [i].[OneToOne_Optional_Self2Id]
FROM [LevelOne] AS [l1]
LEFT JOIN [LevelTwo] AS [l1.OneToOne_Optional_FK1] ON [l1].[Id] = [l1.OneToOne_Optional_FK1].[Level1_Optional_Id]
LEFT JOIN [LevelTwo] AS [i] ON [l1].[Id] = [i].[Level1_Optional_Id]
WHERE ([l1.OneToOne_Optional_FK1].[Name] <> N'Foo') OR [l1.OneToOne_Optional_FK1].[Name] IS NULL");
        }

        public override void GroupJoin5()
        {
            base.GroupJoin5();

            AssertSql(
                @"SELECT [i].[Id], [i].[Date], [i].[Level1_Optional_Id], [i].[Level1_Required_Id], [i].[Name], [i].[OneToMany_Optional_Inverse2Id], [i].[OneToMany_Optional_Self_Inverse2Id], [i].[OneToMany_Required_Inverse2Id], [i].[OneToMany_Required_Self_Inverse2Id], [i].[OneToOne_Optional_PK_Inverse2Id], [i].[OneToOne_Optional_Self2Id], [ti.OneToOne_Required_PK2].[Id], [ti.OneToOne_Required_PK2].[Level2_Optional_Id], [ti.OneToOne_Required_PK2].[Level2_Required_Id], [ti.OneToOne_Required_PK2].[Name], [ti.OneToOne_Required_PK2].[OneToMany_Optional_Inverse3Id], [ti.OneToOne_Required_PK2].[OneToMany_Optional_Self_Inverse3Id], [ti.OneToOne_Required_PK2].[OneToMany_Required_Inverse3Id], [ti.OneToOne_Required_PK2].[OneToMany_Required_Self_Inverse3Id], [ti.OneToOne_Required_PK2].[OneToOne_Optional_PK_Inverse3Id], [ti.OneToOne_Required_PK2].[OneToOne_Optional_Self3Id]
FROM [LevelOne] AS [l1]
LEFT JOIN [LevelTwo] AS [l1.OneToOne_Optional_FK1] ON [l1].[Id] = [l1.OneToOne_Optional_FK1].[Level1_Optional_Id]
LEFT JOIN [LevelTwo] AS [i] ON [l1].[Id] = [i].[Level1_Optional_Id]
LEFT JOIN [LevelThree] AS [ti.OneToOne_Required_PK2] ON [l1.OneToOne_Optional_FK1].[Id] = [ti.OneToOne_Required_PK2].[Id]
WHERE ([l1.OneToOne_Optional_FK1].[Name] <> N'Foo') OR [l1.OneToOne_Optional_FK1].[Name] IS NULL");
        }

        public override void GroupJoin6()
        {
            base.GroupJoin6();

            AssertSql(
                @"SELECT [o].[Id], [o].[Date], [o].[Name], [o].[OneToMany_Optional_Self_Inverse1Id], [o].[OneToMany_Required_Self_Inverse1Id], [o].[OneToOne_Optional_Self1Id], [ti.OneToOne_Required_FK2].[Id], [ti.OneToOne_Required_FK2].[Level2_Optional_Id], [ti.OneToOne_Required_FK2].[Level2_Required_Id], [ti.OneToOne_Required_FK2].[Name], [ti.OneToOne_Required_FK2].[OneToMany_Optional_Inverse3Id], [ti.OneToOne_Required_FK2].[OneToMany_Optional_Self_Inverse3Id], [ti.OneToOne_Required_FK2].[OneToMany_Required_Inverse3Id], [ti.OneToOne_Required_FK2].[OneToMany_Required_Self_Inverse3Id], [ti.OneToOne_Required_FK2].[OneToOne_Optional_PK_Inverse3Id], [ti.OneToOne_Required_FK2].[OneToOne_Optional_Self3Id]
FROM [LevelOne] AS [o]
LEFT JOIN [LevelTwo] AS [i] ON [o].[Id] = [i].[Level1_Optional_Id]
LEFT JOIN [LevelThree] AS [ti.OneToOne_Required_FK2] ON [i].[Id] = [ti.OneToOne_Required_FK2].[Level2_Required_Id]");
        }

        public override void GroupJoin7()
        {
            base.GroupJoin7();
        ...
        public override void GroupJoin8()
        {
            base.GroupJoin8();
        ...
        public override void GroupJoin9()
        {
            base.GroupJoin9();
        ...
        public override void GroupJoin10()
        {
            base.GroupJoin10();
        ...
        public override void GroupJoin11()
        {
            base.GroupJoin11();
...
LEFT JOIN [LevelThree] AS [l3] ON [l2].[Id] = [l3].[Id]");
        ...
        public override void GroupJoin12()
        {
            base.GroupJoin12();
        ...
        public override void GroupJoin13()
        {
            base.GroupJoin13();
