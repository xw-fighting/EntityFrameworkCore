...
#pragma warning restore IDE0031 // Use null propagation
        ...
        [ConditionalFact]
        public virtual void Nav5_1()
        {
            using (var ctx = CreateContext())
            {
                var query = ctx.LevelOne
                    .Select(l1 => new { foo = l1.OneToOne_Optional_FK1, bar = l1.OneToOne_Optional_FK1, baz = l1.OneToOne_Optional_PK1 })
                    .Distinct()
                    .Where(x => x.foo.OneToOne_Optional_PK2.Name != "Foo");
        ...
        public virtual void Nav5_2()
        {
            using (var ctx = CreateContext())
            {
                var query = ctx.LevelOne
                    ...
                    .Distinct()
                    .Where(x => x.foo.OneToOne_Optional_PK2.Name != "Foo")
                    .Where(x => x.foo.OneToOne_Optional_PK2.Name != "Bar")
                    .OrderBy(x => x.baz != null ? x.baz.Name : "1");
        ...
        [ConditionalFact]
        public virtual void Nav5_3()
        {
            using (var ctx = CreateContext())
            {
                var query = ctx.LevelOne
                    .Select(l1 => new { foo = l1.OneToOne_Optional_FK1, name = l1.OneToOne_Optional_PK1.Name })
                    .Distinct()
                    .Where(x => x.foo.OneToOne_Optional_PK2.Name != "Foo")
                    .Where(x => x.name != "Bar");
        ...
        [ConditionalFact]
        public virtual void Join8()
        {
            using (var ctx = CreateContext())
            {
                var query = ctx.LevelOne.Select(l1 => new { nav1 = l1.OneToOne_Optional_PK1, entity1 = l1, prop1 = l1.Id }).Distinct()
                    .Join(ctx.LevelTwo.Select(l2 => new { n2 = l2.OneToOne_Optional_FK2, e2 = l2, p2 = l2.Id }).Distinct(),
                    o => o.nav1.Id, i => i.p2, (o, i) => new { outer_nav = o.nav1.OneToOne_Optional_PK2, outer_entity = o.entity1.OneToOne_Optional_PK1, outer_prop = o.prop1, inner_nav = i.n2.OneToOne_Required_FK3, inner_entity = i.e2.OneToOne_Optional_FK2, inner_prop = i.p2 });
                var result = query.ToList();
            }
        }
